from src.agent.enhancement.informations_team import fas_research_team 
from src.agent.enhancement.reasonning_team import reasoning_team_leader
from src.agent.enhancement.compliance_team import compliance_team_leader
