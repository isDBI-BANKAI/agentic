...
- Each section should have a "tag" field that indicates the type of content or the context it belongs, these tags are highly needed for filtered retrieval. Tags are really important, they basically provide for the agents a way to filter the content and get the right context for their tasks. Think of it as a key to the content, for example you can outline a key shared among the terms of a certain stage of the accounting treatment.
